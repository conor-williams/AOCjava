...
class year2023_day18 {
	//	        public static int maxPath = 0;
	public static int lenx = 4000;
	public static int leny = 4000;
	...
	public static void main(String [] args) {
		...
		for (int i = 0; i < blah.size(); i++) {
			...
			instr.inst = m.group(1).charAt(0);
			instr.nummoves = Integer.valueOf(m.group(2));
			takemove(instr);
		}
	...
	public static void floodpuzzle(int myx, int myy, char what)
	{
		if (puzzle[myy][myx] == '.') {
			puzzle[myy][myx] = what;
	...
	public static void controllerfloodpuzzle(char what)
	{
		int y = 0; int x = 0;
		for (x = 0; x< lenx; x++) {
	...
	public static void takemove(instruction instr)
	{
		switch (instr.inst) {
			case 'L':
