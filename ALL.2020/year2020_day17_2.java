...
class year2020_day17_2 {
	//	        public static int maxPath = 0;
	public static int lenx = 0;
	public static int leny = 0;
	public static int lenz = 0;
	public static int GX = 20;
	public static char grid [][][][] = new char[GX][GX][GX][GX];
	public static char gridtmp [][][][] = new char[GX][GX][GX][GX];
	public static char gridInitial [][] = new char[GX][GX];
	...
	public static void main(String [] args) {
		...
		gridInitial = new char[leny][lenx];
		for (int i = 0; i < blah.size();i++) {
			gridInitial[i] = blah.get(i).toCharArray();
		}
