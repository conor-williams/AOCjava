	...
	public static void main(String [] args) {
		...
		*/
		...
		for (int i = 0; i < blah.size(); i++) {
			...
			out.print("way ns = "); out.println(ns);
			out.print("way ew = "); out.println(ew);
			out.print("mov ns = "); out.println(movns);
			out.print("mov ew = "); out.println(movew);
		//	Scanner scanner = new Scanner(System.in); scanner.nextLine();
		}
		System.setOut(originalOut);
		out.print("**j_ans: ");
		out.print(Math.abs(movns) + Math.abs(movew));
		out.println("");
	}
}
