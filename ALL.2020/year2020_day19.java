...
class year2020_day19 {
	...
	public static void main(String [] args) {
		...
		numMatches = leny;
		String rule0 = new String(rules[0]);
		...
		for (int i = 0; i < numMatches; i++) {
			Pattern p3 = Pattern.compile(rule0);
			Matcher m3 = p3.matcher(matches[i]);
			//out.print(rule0); out.print(" V "); out.println(matches[i]);
			if (m3.find()) {
				///out.println("yes");
				count++;
			}
