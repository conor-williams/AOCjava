...
class year2020_day17 {
	//	        public static int maxPath = 0;
	public static int lenx = 0;
	public static int leny = 0;
	public static int lenz = 0;
	public static int GX = 200;
	public static char grid [][][] = new char[GX][GX][GX];
	public static char gridtmp [][][] = new char[GX][GX][GX];
