...
class year2020_day13 {
	...
	public static void main(String [] args) {
		...
		Vector <Integer> buses = new Vector<>();
		...
		for (int ii = 0; ii < buses.size(); ii++) {
			int xx = timeDepart / buses.get(ii);
			xx++;
			int ti = xx * buses.get(ii);

			if (ti - timeDepart < min) {min = ti-timeDepart; minid = buses.get(ii);}
		}
