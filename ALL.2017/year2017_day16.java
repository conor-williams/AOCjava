			...
			while (scanner.hasNext()) {
				...
				switch (ne.charAt(0)) {
					case 's':
						...
						String move = sb.toString().substring(len-num1);
						//out.print("move:"); out.println(move);
						sb = new StringBuilder(sb.toString().substring(0, len-num1));
						//out.print("keep:"); out.println(sb);
						sb = new StringBuilder(move+sb);
							//ch1 = sb.charAt(len-ii);
							//sb.deleteCharAt(len-1);
							//move += ""+ch1;

							//sb = new StringBuilder(""+ch1 + sb);
						//ch1 = sb.charAt(ind1);
					...
					case 'p':
						...
						ind1 = sb.toString().indexOf(ch1);
						ind2 = sb.toString().indexOf(ch2);
