...
class year2017_day6_2 {
	public static int [][] keypad = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
	public static void main(String [] args) {
		out.println("		2017 Day6.2");
		...
		int count = 0;
		Vector <Integer> startCycle = new Vector<>();
		while (1 == 1) {
			if (states.contains(var_ints)) {startCycle = new Vector<>(var_ints); break;}
		...
		while (1 == 1) {
			...
			count2++;
			if (var_ints.equals(startCycle)) {break;}
		}
