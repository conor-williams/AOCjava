...
class year2017_day14_2 {
	public static int [][] keypad = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
	public static char grid [][] = new char[128][128];
	public static int already [][] = new int[128][128];
	public static void main(String [] args) {
		out.println("		2017 Day14.2");
		...
		*/
		...
		out.print("**j_ans: ");
		out.println(region-1);
		out.println();
	}
	public static void next(int x, int y, int region) {
		if (x < 0 || x >= 128 || y < 0 || y>= 128) {return;}
		if (grid[y][x] == '.' || already[y][x] != 0) {
			return;
		}
		already[y][x] = region;
		next(x, y-1, region);
