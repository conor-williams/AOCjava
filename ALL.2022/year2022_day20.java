...
class year2022_day20 {
	...
	static int gPo1 = 0;
	static Vector <Integer> veOrig = new Vector<>();
	static Vector <Integer> ve3 = new Vector<>();
	...
	public static void main(String [] args) {
		...
		for (int i = 0; i < blah.size(); i++) {
			veOrig.add(Integer.valueOf(blah.get(i)));
			ve3.add(Integer.valueOf(blah.get(i)));
		}
