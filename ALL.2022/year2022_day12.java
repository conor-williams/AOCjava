...
after:
		...
		out.print("stx:"); out.println(stx); out.print(" sty: "); out.println(sty);
		out.print("enx:"); out.println(enx); out.print("eny: "); out.println(eny);
		out.print("len: "); out.println(lenx);
		out.print("leny: "); out.println(leny);

		
		//already[sty][stx] = 1;
		grid[sty][stx] = 'a';
		grid[eny][enx] = 'z';
		next(stx, sty, enx, eny, 'a', 0);
