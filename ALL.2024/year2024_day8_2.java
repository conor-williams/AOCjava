...
class year2024_day8_2 {
	public static int sy = 50; public static int sx = 50;
	//public static int sy = 12; public static int sx = 12;
	public static char [][] grid = new char[sy][sx];

	public static void main(String [] args) {
		out.println("		2024 Day8.2");
		...
		for (int ii = 0; ii < 26; ii++) {
			...
			for (int ll = 0; ll < carsUp[ii].size()-1; ll++) {
				...
				for (int kk = ll+1; kk < carsUp[ii].size(); kk++) {
					...
					int times = 0;
					while (1 == 1) {
						int newx1 = tu1.first - (times * distx1);
						int newy1 = tu1.second - (times * disty1);
						Tuple <Integer, Integer> tmp1 = new Tuple(newx1, newy1);
					...
					times = 0;
					while (1 == 1) {
						int newx2 = tu2.first - (times * distx2);
						int newy2 = tu2.second - (times * disty2);
