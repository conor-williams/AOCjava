...
class year2018_day22 {
	...
	public static void main(String [] args) {
		...
		char grid[][] = new char[tY+10][tX+10];
		int geo[][] = new int [tY+10][tX+10];
		int ero[][] = new int[tY+10][tX+10];
		int risk[][] = new int[tY+10][tX+10];
